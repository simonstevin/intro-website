...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Welcome at Simon Stevin!","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Simon Stevin is the Study Association of Mechanical Engineering in Eindhoven. We organize all sorts of activities for Mechanical Engineering students, from parties to welding workshops."}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
